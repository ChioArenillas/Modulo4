...
searchInput.addEventListener("input", () => {
  ...
  debounceTimer = setTimeout(() => aplicarFiltros(movies, movieContainer), 500);
});

selectCategory.addEventListener("change", () => aplicarFiltros(movies, movieContainer));
selectOrder.addEventListener("change", () => aplicarFiltros(movies, movieContainer));
}